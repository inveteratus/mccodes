...
CREATE TABLE `users` (
  ...
  `will` int NOT NULL DEFAULT '100',
  `maxwill` int NOT NULL DEFAULT '100',
  `brave` int NOT NULL DEFAULT '5',
  `maxbrave` int NOT NULL DEFAULT '5',
  `maxenergy` int NOT NULL DEFAULT '12',
  ...
  `lastip_signup` varchar(255) NOT NULL DEFAULT '',
